...
internal sealed class Filter
{
  ...
  private static byte[] LoopFilterLimitValuesV1 = {
  ...
  internal void copyFilterTables(Info ci) {
    Array.Copy(ci.LoopFilterLimitValues, 0, LoopFilterLimits, 0, Constants.Q_TABLE_SIZE);
  }

  /* initialize the filter limits from our static table */
  internal void InitFilterTables() {
    Array.Copy(LoopFilterLimitValuesV1, 0, LoopFilterLimits, 0, Constants.Q_TABLE_SIZE);
  }

  internal void SetupLoopFilter(int FrameQIndex){
    int FLimit;
  ...
  internal void LoopFilter(Playback pbi){
