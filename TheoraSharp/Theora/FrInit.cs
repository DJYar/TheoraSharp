...
public class FrInit
{
  ...
  internal static void ClearFragmentInfo(Playback pbi){
  ...
  static void InitFragmentInfo(Playback pbi){
    ...
    pbi.QFragData = new short[pbi.UnitFragments][];
    for (int i = 0; i < pbi.UnitFragments; i++)
      pbi.QFragData[i] = new short[64];
  ...
  internal static void ClearFrameInfo(Playback pbi){
  ...
  internal static void InitFrameDetails(Playback pbi){
